...
CREATE TABLE `channels` (
  ...
  PRIMARY KEY (`id`)
) WITH SYSTEM VERSIONING ENGINE = InnoDB  DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Various channels thru which the member can submit for the assessments';
...
CREATE TABLE `members` (
  ...
  `effectiveFrom` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) WITH SYSTEM VERSIONING  ENGINE = InnoDB  DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Members master table';
...
CREATE TABLE `question_types_lookup` (
  ...
  PRIMARY KEY (`id`)
)  WITH SYSTEM VERSIONING ENGINE = InnoDB  DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'A lookup table with all the possible question types';
...
) WITH SYSTEM VERSIONING  ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci;
...
CREATE TABLE `answers` (
  ...
  `effectiveFrom` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) WITH SYSTEM VERSIONING  ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Possible answers for the questions';
...
CREATE TABLE `answer_groups` (
  ...
  `effectiveFrom` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
)  WITH SYSTEM VERSIONING ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Grouping answers together in a logical sense';
...
)  WITH SYSTEM VERSIONING ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'The Question Bank';
...
)  WITH SYSTEM VERSIONING ENGINE = InnoDB  DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Association between a question and corresponding answer';
...
CREATE TABLE `assessments` (
  ...
  `effectiveFrom` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
)  WITH SYSTEM VERSIONING ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'assessments Master Table';
...
)  WITH SYSTEM VERSIONING ENGINE = InnoDB  DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Association between an assessment and the questions in the assessment';
...
)  WITH SYSTEM VERSIONING ENGINE = InnoDB  DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Association between an assessment and members participating in the assessment';
...
) WITH SYSTEM VERSIONING  ENGINE = InnoDB DEFAULT CHARSET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'Answers submitted by the member for a particular assessment';
